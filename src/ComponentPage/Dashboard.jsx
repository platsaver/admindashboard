      ...
      <Col span={8}  xs={24} lg={8}>
        ...
        >
          <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-gray-800"> Độ hài lòng của khách hàng</span>
              </div>
              <Progress
                percent={85}
                strokeColor="#faad14"
                ...
                <div className="w-full">
                  <div className="flex justify-between items-start" style={{ fontSize: '16px' }}>
                    <strong className="text-gray-800">
                      {item.date} {item.count > 0 && <span className="text-red-500"></span>}
                    </strong>
                  </div>
                  <ul className="mt-2" style={{ fontSize: '16px' }}>
                    {item.events.map((event, index) => (
                      <li key={index} className="py-2 border-b border-gray-400 last:border-b-0">
